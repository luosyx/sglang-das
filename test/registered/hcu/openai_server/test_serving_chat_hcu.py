...
class ServingChatTestCase(unittest.TestCase):
    ...
    def test_dpsk_v32_encoding_path(self):
        ...
        server_args = ServerArgs(
            model_path=os.environ.get(
                "SGLANG_TEST_DEFAULT_DEEPSEEK_V32_MODEL",
    ...
    def test_streaming_abort_yields_error(self):
        ...
        # Current stream may include a partial content chunk before the abort error.
        self.assertGreaterEqual(len(chunks), 2)
        self.assertTrue(any("error" in chunk for chunk in chunks[:-1]))
